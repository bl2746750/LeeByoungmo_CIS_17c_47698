...
class SimpleVector{
    ...
    public:
        static int opeq,oplt,opinc,opindex,opplus,opmin,opgt,opmul;
       // Default constructor
       SimpleVector()
          { aptr = 0; arraySize = 0;}
...
template <class T>
int SimpleVector<T>::opeq=0;
template <class T>
int SimpleVector<T>::oplt=0;
template <class T>
int SimpleVector<T>::opinc=0;
template <class T>
int SimpleVector<T>::opindex=0;
template <class T>
int SimpleVector<T>::opplus=0;
template <class T>
int SimpleVector<T>::opmin=0;
template <class T>
int SimpleVector<T>::opgt=0;
template <class T>
int SimpleVector<T>::opmul=0;
//***********************************************************
