...
//    auto duration2 = duration_cast<microseconds>(stop2 - start2);
    ...
    auto start1 = chrono::high_resolution_clock::now();
    cout <<linSrch(array,SIZE,value)<<endl;
    auto stop1 = chrono::high_resolution_clock::now();
    auto duration1 = duration_cast<microseconds>(stop1 - start1);        
    
    cout << "Size=" << SIZE << endl;
    cout << "Time(Linea Search) = " << duration1.count() << endl;
    ...
    cout << "Total Operations: " << opeq1+opgt1+opinc1+opindex1+
            oplt1+opmin1+opplus1 << endl << endl;
    
    cout<<"Using the Binary Search"<<endl;
    cout<<"The value "<<value<<" was found at position ";
    auto start2 = chrono::high_resolution_clock::now();
    cout <<binSrch(brray,SIZE,value)<<endl;
    auto stop2 = chrono::high_resolution_clock::now();
    auto duration2 = duration_cast<microseconds>(stop2 - start2);
...
int  binSrch(int a[],int n, int val){
    ...
    do{
        ...
        if(val==a[middle]){
            ...
            opgt++;opindex++;opeq++;opplus++;
            lowEnd=middle+1;
        }
        else {
            oplt++;opindex++;opeq++;opmin++;
            highEnd=middle-1;
        }
        oplt++;
