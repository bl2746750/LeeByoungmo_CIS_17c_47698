 ...
 * Created on October 19th, 2018, 3:22 PM
...
class LinkedList{
    ...
    public:
        static int opeq,oplt,opinc,opindex,opplus,opmin,opgt,opmul,opneq; 
        LinkedList(const T&);
        ~LinkedList();
...
template <class T>
int LinkedList<T>::opeq=0;
template <class T>
int LinkedList<T>::oplt=0;
template <class T>
int LinkedList<T>::opinc=0;
template <class T>
int LinkedList<T>::opindex=0;
template <class T>
int LinkedList<T>::opplus=0;
template <class T>
int LinkedList<T>::opmin=0;
template <class T>
int LinkedList<T>::opgt=0;
template <class T>
int LinkedList<T>::opmul=0;
template <class T>
int LinkedList<T>::opneq=0;
