...
int Hands::getHands() {
    ...
    if (this->isStraight != 0 && this->isFlush != 0) {
        ...
        for (auto& it : this->Hands::getMyCards()) {
            if (it.getSuit() == this->isFlush) {
                stFl.insert(it.getFace());
            }
        }
    ...
    } else if (this->Hands::isPair == 7) {
        this->hands = 7;
    } else if (this->isPair == 6) {
        this->hands = 6;
    } else if (this->isFlush != 0) {
        this->hands = 5;
    } else if (this->isStraight != 0) {
        this->hands = 4;
    } else if (this->isPair == 3) {
        this->hands = 3;
    } else if (this->isPair = 2) {
        this->hands = 2;
    } else if (this->isPair = 1) {
        this->hands = 1;
    } else {
        this->hands = 0;
    }
...
void Hands::checkStraight() {
    ...
    while (it != faceSet.end() && cnt != 4) {
        if (*it - *faceSet.upper_bound(*it) == 1) {
            cnt++;
        } else {
            cnt = 0;
        }
    ...
    if (cnt == 4 && *it + 4 != 14) {
        this->isStraight = *it + 4;
    } else if (cnt == 4 && *it + 4 == 14) {
        this->isStraight = 15;
    }
    if (*it == 14) {
